...
const detailButtomClose =document.querySelector('.detail-of-product-close')
...
const detailOfProduct = document.querySelector('.detail-of-product')
...
detailButtomClose.addEventListener('click', closeDetailOfProduct)

//esta funcion saca y pone la clase inactive
function mostrarMenuEmail() {
    const isAsideCarritoClosed = shoppingCard.classList.contains('inactive')
    if (isAsideCarritoClosed){
        shoppingCard.classList.add('inactive')
    }
        desktopMenu.classList.toggle('inactive')
        closeDetailOfProduct()
...
const isDetailProductClosed = detailOfProduct.classList.contains('inactive')
...
function chargerProducts(arr) {
    for (product of arr){
     ...
     //Crear etiqueta img principal del producto
        ...
        imgPrincipal.addEventListener('click',openDetailProduct)
